...
## 📌 Part 8. 사용 방안 고찰 (Future Utilization & Case Study)

### 버스·지하철 승하차 데이터를 활용한 도시 핫플레이스 탐구

DBSCAN은 공간 기반 데이터를 다루는 데 특히 강력하기 때문에, **대중교통 승하차 데이터 분석**에 매우 효과적으로 활용될 수 있다.  
...
핵심 아이디어는 **특정 시간대·특정 지역에서 승하차 인원이 과밀하게 형성된 지점을 군집(Hotspot)으로 파악하는 것**이다.
